...
面向本仓负责人发布 PR 时，标题和正文必须使用中文；命令、路径、标识符、测试名称和必要的外部专名保持原文，除非负责人明确要求其他语言。
若实际工具面出现未列入当前 profile inventory 的 MCP，所有 profile 必须立即向负责人告警，列出名称、来源证据和配置／生效层级；不得静默继续。
